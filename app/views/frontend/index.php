...
<main id="main">
                ...
                <div class="row g-5">
                    <div class="col-lg-4">
                        ...
                        <div class="post-entry-1 lg">
                            ...
                            <h2><a href="/post/<?= $firstPost->id ?>"><?php echo htmlspecialchars($firstPost->title); ?></a></h2>
                            <p class="mb-4 d-block"><?php echo htmlspecialchars($firstPost->summary); ?></p>
                            <?php if(false) :?>
                            ...
                            <?php foreach ($posts as $post) : ?>
                                <div class="col-lg-4 border-start custom-border">
                                    <div class="post-entry-1">
                                        ...
                                        <div class="post-meta"><span class="date">Category</span> <span class="mx-1">&bullet;</span> <span><?php $date = strtotime($post->created_at); echo date('Y M', $date); ?></span></div>
                                        <h2><a href="/post/<?= $post->id ?>"><?php echo htmlspecialchars($post->title); ?></a></h2>
    ...
    <?php
    // TODO Make a list of blogs for each category
    if(false) :?>
